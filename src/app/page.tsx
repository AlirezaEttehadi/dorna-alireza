...
export default function Home() {
  return (
    <div className="relative">
      ...
      <button className="font-bold text-[#4D4A23] bg-[#807B3B0F] border border-[#807B3B] p-3 rounded-3xl w-[342px]">
        مسیریابی
      </button>
      <Image
        src="/images/bottom.png"
